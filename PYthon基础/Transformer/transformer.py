...
"""
掩码：生成一个用于在自注意力机制中屏蔽（mask）填充位置的掩码（mask）
        把占位符mask掉
"""
...
"""
掩码：生成一个用于在自注意力机制中屏蔽（mask）未来位置信息的掩码（mask），避免模型在预测时利用未来信息
"""
...
"""
缩放点积注意力 :  使用于多头注意力中，防止内积结果过大，导致梯度消失或梯度爆炸的问题
"""
